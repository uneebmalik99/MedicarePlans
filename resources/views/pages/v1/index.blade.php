...
@section('content')
    ...
    <style>
        ...
        #valid_name,#valid_email,#valid_phone, #valid_yes_no, #valid_age{
            display: none;
        }
        .form-group{
    ...
    <div class="container rounded">
        ...
        <div class="card">
            <header class="rounded">
                ...
                <h4 style="text-align: center;">Seniors are eligible for Medicare Flex Card assistance for groceries, dentures, eyeglasses, and hearing aids based on zip code</h6>
                </div>
            </header>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                        ...
                        <div class="row mt-2">
                            <div class="col-12 ">
                                <div class="d-flex justify-content-around align-items-center">
                                    <label class="btn bd_class_1 option-col age_btn">
                                        ...
                                        <input type="radio" style="border:none;outline:none"  name="bd_class" value="64-70"/>
                                        <span>64-70</span>
                                    </label>
    
                                    <label class ="btn bd_class_2 option-col age_btn">   
                                        <svg width="20" height="20" viewBox="0 0 38 38" fill="none"
                                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <rect width="38" height="38" fill="url(#pattern0)" />
                                            <defs>
                                    ...
                                    <div class="btn bd_class_3 option-col age_btn">
                                        <svg width="20" height="20" viewBox="0 0 38 38" fill="none"
                                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <rect width="38" height="38" fill="url(#pattern0)" />
                                            <defs>
                                ...
                                <span class="style_age text-danger text-center mt-1" id="valid_age" style="margin-left:55px;">Select One Button </span>
                        ...
                        <div class="row mt-5">
                            <div class="col-12 form_text">
                                <p class="question_text_f1" style="text-align:center">Are you interested in a 2023 Medicare plan with Flex Card benefits?</p>
                            ...
                            <div class="col-8 mx-auto ">
                                ...
                                <br>
                                <span class="style_yes_no text-danger text-center" id="valid_yes_no" style="margin-left:102px;">Select One Button </span>
                            </div>
                        ...
                        <div class="">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="formGroupExampleInput"
                                    placeholder="john galvagno" onkeyup="validate_all_fields()">
                                <p class="style_name text-danger mt-1" id="valid_name">Enter Valid Name</p>
                                
                            </div>
                            <div class="form-group">
                                <label class="input_label" for="email">Email<span class="text-danger" style="font-size:18px">*</span></label>
                                <input type="text" name="email" class="form-control" id="email"
                                    placeholder="email@address.com" onkeyup="validate_all_fields()">
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-center align-items-center">
                    <button class="result_btn" type="button" onclick="validate_form()">View My Results</button>
                </div>
    ...
    <script>
        ...
        function validate_all_fields(){
            ...
            if(btn_y_no == true && age_btn == true && name.length >= 2 && (/^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$/.test(email)) && (/^\([0-9]{3}\) [0-9]{3}\-[0-9]{4}$/.test(phone))){
